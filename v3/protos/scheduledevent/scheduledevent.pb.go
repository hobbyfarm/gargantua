...
var file_scheduledevent_scheduledevent_proto_rawDesc = string([]byte{
...
var (
	...
	file_scheduledevent_scheduledevent_proto_rawDescData []byte
)
...
func file_scheduledevent_scheduledevent_proto_rawDescGZIP() []byte {
	file_scheduledevent_scheduledevent_proto_rawDescOnce.Do(func() {
		file_scheduledevent_scheduledevent_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_scheduledevent_scheduledevent_proto_rawDesc), len(file_scheduledevent_scheduledevent_proto_rawDesc)))
	})
...
func file_scheduledevent_scheduledevent_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_scheduledevent_scheduledevent_proto_rawDesc), len(file_scheduledevent_scheduledevent_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   12,
			NumExtensions: 0,
			NumServices:   1,
