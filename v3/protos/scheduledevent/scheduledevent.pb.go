...
type ScheduledEvent struct {
	...
	RequiredVms         map[string]*VMTemplateCountMap `protobuf:"bytes,12,rep,name=required_vms,json=requiredVms,proto3" json:"required_vms,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
...
type VMTemplateCountMap struct {
	state            protoimpl.MessageState `protogen:"open.v1"`
	VmTemplateCounts map[string]uint32      `protobuf:"bytes,1,rep,name=vmTemplateCounts,proto3" json:"vmTemplateCounts,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
