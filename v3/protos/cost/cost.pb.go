...
type Cost struct {
	...
	Total         uint64                 `protobuf:"varint,2,opt,name=total,proto3" json:"total,omitempty"`                         // total cost for all sources
...
type CostSource struct {
	...
	Cost          uint64                 `protobuf:"varint,2,opt,name=cost,proto3" json:"cost,omitempty"` // total cost for this kind
...
func (x *CostSource) GetCost() uint64 {
	if x != nil {
		return x.Cost
	}
	return 0
...
type CreateOrUpdateCostRequest struct {
	...
	Kind                  string                 `protobuf:"bytes,3,opt,name=kind,proto3" json:"kind,omitempty"` // like VirtualMachine
	BasePrice             uint64                 `protobuf:"varint,4,opt,name=base_price,json=basePrice,proto3" json:"base_price,omitempty"`
	TimeUnit              string                 `protobuf:"bytes,5,opt,name=time_unit,json=timeUnit,proto3" json:"time_unit,omitempty"`
	Id                    string                 `protobuf:"bytes,6,opt,name=id,proto3" json:"id,omitempty"`                                                                             // resource id
	CreationUnixTimestamp int64                  `protobuf:"varint,7,opt,name=creation_unix_timestamp,json=creationUnixTimestamp,proto3" json:"creation_unix_timestamp,omitempty"`       // unix timestamp in seconds
	DeletionUnixTimestamp *int64                 `protobuf:"varint,8,opt,name=deletion_unix_timestamp,json=deletionUnixTimestamp,proto3,oneof" json:"deletion_unix_timestamp,omitempty"` // unix timestamp in seconds
	unknownFields         protoimpl.UnknownFields
	sizeCache             protoimpl.SizeCache
}
...
func (x *CreateOrUpdateCostRequest) GetBasePrice() uint64 {
	if x != nil {
		return x.BasePrice
	}
	return 0
...
var file_cost_cost_proto_rawDesc = []byte{
	...
	0x04, 0x52, 0x05, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x12, 0x28, 0x0a, 0x06, 0x73, 0x6f, 0x75, 0x72,
	...
	0x28, 0x04, 0x52, 0x04, 0x63, 0x6f, 0x73, 0x74, 0x12, 0x14, 0x0a, 0x05, 0x63, 0x6f, 0x75, 0x6e,
	...
	0x01, 0x28, 0x04, 0x52, 0x09, 0x62, 0x61, 0x73, 0x65, 0x50, 0x72, 0x69, 0x63, 0x65, 0x12, 0x1b,
	0x0a, 0x09, 0x74, 0x69, 0x6d, 0x65, 0x5f, 0x75, 0x6e, 0x69, 0x74, 0x18, 0x05, 0x20, 0x01, 0x28,
	0x09, 0x52, 0x08, 0x74, 0x69, 0x6d, 0x65, 0x55, 0x6e, 0x69, 0x74, 0x12, 0x0e, 0x0a, 0x02, 0x69,
	0x64, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52, 0x02, 0x69, 0x64, 0x12, 0x36, 0x0a, 0x17, 0x63,
	0x72, 0x65, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x75, 0x6e, 0x69, 0x78, 0x5f, 0x74, 0x69, 0x6d,
	0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x18, 0x07, 0x20, 0x01, 0x28, 0x03, 0x52, 0x15, 0x63, 0x72,
	...
	0x75, 0x6e, 0x69, 0x78, 0x5f, 0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x18, 0x08,
