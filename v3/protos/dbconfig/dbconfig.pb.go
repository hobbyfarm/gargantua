...
type DynamicBindConfig struct {
	...
	BurstCountCapacity  map[string]uint32      `protobuf:"bytes,6,rep,name=burst_count_capacity,json=burstCountCapacity,proto3" json:"burst_count_capacity,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`
...
type CreateDynamicBindConfigRequest struct {
	...
	BurstCountCapacity  map[string]uint32      `protobuf:"bytes,4,rep,name=burst_count_capacity,json=burstCountCapacity,proto3" json:"burst_count_capacity,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"varint,2,opt,name=value"`
...
var file_dbconfig_dbconfig_proto_rawDesc = string([]byte{
...
var (
	...
	file_dbconfig_dbconfig_proto_rawDescData []byte
)

func file_dbconfig_dbconfig_proto_rawDescGZIP() []byte {
	file_dbconfig_dbconfig_proto_rawDescOnce.Do(func() {
		file_dbconfig_dbconfig_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_dbconfig_dbconfig_proto_rawDesc), len(file_dbconfig_dbconfig_proto_rawDesc)))
	})
...
func file_dbconfig_dbconfig_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_dbconfig_dbconfig_proto_rawDesc), len(file_dbconfig_dbconfig_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   8,
			NumExtensions: 0,
			NumServices:   1,
