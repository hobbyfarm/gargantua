...
var file_vmset_virtualmachineset_proto_rawDesc = string([]byte{
...
var (
	...
	file_vmset_virtualmachineset_proto_rawDescData []byte
)

func file_vmset_virtualmachineset_proto_rawDescGZIP() []byte {
	file_vmset_virtualmachineset_proto_rawDescOnce.Do(func() {
		file_vmset_virtualmachineset_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_vmset_virtualmachineset_proto_rawDesc), len(file_vmset_virtualmachineset_proto_rawDesc)))
	})
...
func file_vmset_virtualmachineset_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_vmset_virtualmachineset_proto_rawDesc), len(file_vmset_virtualmachineset_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   9,
			NumExtensions: 0,
			NumServices:   1,
