...
const (
	resourcePlural = rbac2.ResourcePluralEnvironment
)
...
func (e EnvironmentServer) GetFunc(w http.ResponseWriter, r *http.Request) {
	user, err := rbac2.AuthenticateRequest(r, e.authnClient)
	if err != nil {
	...
	authrResponse, err := rbac2.AuthorizeSimple(r, e.authrClient, impersonatedUserId, rbac2.HobbyfarmPermission(resourcePlural, rbac2.VerbGet))
...
func (e EnvironmentServer) ListFunc(w http.ResponseWriter, r *http.Request) {
	...
	impersonatedUserId := user.GetId()
	authrResponse, err := rbac2.AuthorizeSimple(r, e.authrClient, impersonatedUserId, rbac2.HobbyfarmPermission(resourcePlural, rbac2.VerbList))
	if err != nil || !authrResponse.Success {
...
func (e EnvironmentServer) CreateFunc(w http.ResponseWriter, r *http.Request) {
	...
	impersonatedUserId := user.GetId()
	authrResponse, err := rbac2.AuthorizeSimple(r, e.authrClient, impersonatedUserId, rbac2.HobbyfarmPermission(resourcePlural, rbac2.VerbCreate))
	if err != nil || !authrResponse.Success {
...
func (e EnvironmentServer) UpdateFunc(w http.ResponseWriter, r *http.Request) {
	...
	impersonatedUserId := user.GetId()
	authrResponse, err := rbac2.AuthorizeSimple(r, e.authrClient, impersonatedUserId, rbac2.HobbyfarmPermission(resourcePlural, rbac2.VerbUpdate))
	if err != nil || !authrResponse.Success {
