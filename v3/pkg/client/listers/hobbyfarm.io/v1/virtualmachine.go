...
type VirtualMachineLister interface {
	...
	List(selector labels.Selector) (ret []*hobbyfarmiov1.VirtualMachine, err error)
...
type virtualMachineLister struct {
	listers.ResourceIndexer[*hobbyfarmiov1.VirtualMachine]
}
...
func NewVirtualMachineLister(indexer cache.Indexer) VirtualMachineLister {
	return &virtualMachineLister{listers.New[*hobbyfarmiov1.VirtualMachine](indexer, hobbyfarmiov1.Resource("virtualmachine"))}
}

// VirtualMachines returns an object that can list and get VirtualMachines.
func (s *virtualMachineLister) VirtualMachines(namespace string) VirtualMachineNamespaceLister {
	return virtualMachineNamespaceLister{listers.NewNamespaced[*hobbyfarmiov1.VirtualMachine](s.ResourceIndexer, namespace)}
}
...
type VirtualMachineNamespaceLister interface {
	...
	// Objects returned here must be treated as read-only.
	Get(name string) (*hobbyfarmiov1.VirtualMachine, error)
