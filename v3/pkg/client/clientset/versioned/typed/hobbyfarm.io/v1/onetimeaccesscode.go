...
func (c *oneTimeAccessCodes) List(ctx context.Context, opts metav1.ListOptions) (result *v1.OneTimeAccessCodeList, err error) {
	...
	result = &v1.OneTimeAccessCodeList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("onetimeaccesscodes").
...
func (c *oneTimeAccessCodes) Create(ctx context.Context, oneTimeAccessCode *v1.OneTimeAccessCode, opts metav1.CreateOptions) (result *v1.OneTimeAccessCode, err error) {
	result = &v1.OneTimeAccessCode{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("onetimeaccesscodes").
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(oneTimeAccessCode).
		Do(ctx).
		Into(result)
	return
}
...
func (c *oneTimeAccessCodes) Update(ctx context.Context, oneTimeAccessCode *v1.OneTimeAccessCode, opts metav1.UpdateOptions) (result *v1.OneTimeAccessCode, err error) {
	result = &v1.OneTimeAccessCode{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("onetimeaccesscodes").
		Name(oneTimeAccessCode.Name).
		VersionedParams(&opts, scheme.ParameterCodec).
		Body(oneTimeAccessCode).
		Do(ctx).
		Into(result)
...
func (c *oneTimeAccessCodes) DeleteCollection(ctx context.Context, opts metav1.DeleteOptions, listOpts metav1.ListOptions) error {
	var timeout time.Duration
