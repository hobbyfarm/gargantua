...
import (
	"github.com/hobbyfarm/gargantua/v3/pkg/apis/terraformcontroller.cattle.io/v1"
...
// NewForConfigAndClient creates a new TerraformcontrollerV1Client for the given config and http client.
// Note the http client provided takes precedence over the configured transport values.
func NewForConfigAndClient(c *rest.Config, h *http.Client) (*TerraformcontrollerV1Client, error) {
	config := *c
	if err := setConfigDefaults(&config); err != nil {
		return nil, err
	}
	...
	return &TerraformcontrollerV1Client{client}, nil
}

// NewForConfigOrDie creates a new TerraformcontrollerV1Client for the given config and
...
func New(c rest.Interface) *TerraformcontrollerV1Client {
	return &TerraformcontrollerV1Client{c}
}
