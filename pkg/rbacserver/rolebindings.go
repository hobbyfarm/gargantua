...
func (s Server) GetRoleBinding(w http.ResponseWriter, r *http.Request) {
	_, err := s.auth.AuthGrant(rbacclient.RbacRequest().Permission(k8sRbacGroup, roleBindingResourcePlural, rbacclient.VerbGet), w, r)
	if err != nil {
...
func (s Server) CreateRoleBinding(w http.ResponseWriter, r *http.Request) {
	_, err := s.auth.AuthGrant(rbacclient.RbacRequest().Permission(k8sRbacGroup, roleBindingResourcePlural, rbacclient.VerbCreate), w, r)
	if err != nil {
...
func (s Server) UpdateRoleBinding(w http.ResponseWriter, r *http.Request) {
	_, err := s.auth.AuthGrant(rbacclient.RbacRequest().Permission(k8sRbacGroup, roleBindingResourcePlural, rbacclient.VerbUpdate), w, r)
	if err != nil {
...
func (s Server) DeleteRoleBinding(w http.ResponseWriter, r *http.Request) {
	_, err := s.auth.AuthGrant(rbacclient.RbacRequest().Permission(k8sRbacGroup, roleBindingResourcePlural, rbacclient.VerbDelete), w, r)
	if err != nil {
