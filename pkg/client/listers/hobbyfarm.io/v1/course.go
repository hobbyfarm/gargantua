...
// List lists all Courses in the indexer.
func (s *courseLister) List(selector labels.Selector) (ret []*v1.Course, err error) {
...
func (s *courseLister) Get(name string) (*v1.Course, error) {
	...
	if !exists {
		return nil, errors.NewNotFound(v1.Resource("course"), name)
	}
	return obj.(*v1.Course), nil
}
