...
var file_authr_authr_proto_rawDesc = []byte{
	...
	0x61, 0x72, 0x67, 0x61, 0x6e, 0x74, 0x75, 0x61, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x73, 0x2f,
	0x61, 0x75, 0x74, 0x68, 0x72, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}
...
var file_authr_authr_proto_goTypes = []interface{}{
...
func file_authr_authr_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_authr_authr_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AuthRRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_authr_authr_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AuthRResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_authr_authr_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_authr_authr_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
